...
class GraphicsObject:
    ...
    def draw(self, graphwin):
        ...
        """Draw the object in graphwin, which should be a GraphWint
    ...
    def move(self, dx, dy):
        ...
        if canvas and not canvas.isClosed(): #this checks to see if the canvas is closed
            trans = canvas.trans
            print(str(trans) + " This is trans")
            print(str(canvas.trans) + " This is canvas.trans")
            if trans:
                x = dx/ trans.xscale
                print(str(x) + "this is X in trans")
                y = -dy / trans.yscale
                print(str(y) + "this is Y in trans")
            else:
                x = dx
                print(str(x) + "this is x in else")
                y = dy
                print(str(y) + "this is y in else")
    ...
    def _move(self, dx, dy):
        ...
        print("I am in _move in class graphics object")
        pass # must override in subclass
...
class Point(GraphicsObject):
    ...
    def _move(self, dx, dy):
        print("I am in class point _move")
        self.x = self.x + dx
        self.y = self.y + dy
...
class Text(GraphicsObject):
    ...
    def _move(self, dx, dy):
        print("I am in _move in class text")
