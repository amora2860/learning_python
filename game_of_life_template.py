...
def CanvasFrame(text, bloxkwidth,blockheight):
    GraphWin(text, bloxkwidth, blockheight)
...
class Board(object):
    ...
    def __init__(self, text, width, height):
        ...
        self.canvas = CanvasFrame(text, self.width * BLOCK_SIZE, self.height * BLOCK_SIZE)
        #GraphWin.setBackground(canvas, "white")
...
if __name__ == '__main__':    
    ...
    board = Board("Conway's Game of Life", BOARD_WIDTH, BOARD_HEIGHT)
